 ...
 * @LastEditTime: 2022-04-08 09:44:16
...
<template>
    <div>
       <el-dialog title="科目详情" :visible.sync="questioncategoryVisible"  :before-close="close"
       :close-on-click-modal="false"
        >
          <el-button type="success" @click="dialogVisible1 = true" plain>添加科目</el-button>
<el-dialog
  title="科目添加"
